...
- **[2025.05.01]** 🤗 We have released the fine-tuned "td-llama-op" for Overall Performance task. We encourage using this model solely for reproducing the overall performance results. See [HuggingFace Link](https://huggingface.co/HOLILAB/td-llama-op). We have write the instruction to use at the **Experiments** section of this page.
